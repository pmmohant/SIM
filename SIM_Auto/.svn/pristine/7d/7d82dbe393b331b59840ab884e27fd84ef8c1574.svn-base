...
public class SupplierUserPageTests extends PageInitiator {
	 ...
	 * @throws IOException
	 */
	@Test(dataProvider = "SupplierUser", dataProviderClass = ManageUsers.class)
	...
	/**
	 * UserRoles- Supplier User- viewUserActionTest create a user view the user edit the user
	 * 
	 * @author Piramanayagam.S
	 * @param dataMap
	 * @throws InvalidFormatException
