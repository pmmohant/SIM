...
public class InvoiceAdvanceSearch 
   {
	...
	public void buildquery(LinkedHashMap<String, String> dataMap) throws IOException, SQLException 
	{
	...
	private void buildingQuery(LinkedHashMap<String, String> dataMap) throws IOException, SQLException 
	{
	...
	public String[] splitString(String data) throws FileNotFoundException, IOException, SQLException {
	
		String[] x=new String[10];
		if(data.contains(",")){
			x=data.split(",");
			System.out.println(x[0]+":"+x[1]);
			if(x[1].contains("DECLARE")){
				x[1]=lavanteUtils.fetchDBdata(x[1]);
			}
		}else{
			x[0]=data;
		}
