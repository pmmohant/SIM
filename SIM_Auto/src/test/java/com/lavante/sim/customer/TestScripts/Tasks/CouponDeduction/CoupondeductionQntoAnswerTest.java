	...
	public void VerifyPageRestoration() throws Exception{
		...
		if(criteria.size()>0) {
			...
			//	lavanteUtils.switchtoFrame(null);
				...
				Reporter.log("End Search results, Expected: "+searchExpCount1+" Actual: "+actcount,true);
				softassert.assertFalse(searchExpCount1.equals(actcount), "After clear count is not equal to no search count"); 
			
				Reporter.log("End Equal Search results, Expected: "+searchExpCount1+" Actual: "+h,true);
