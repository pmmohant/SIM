...
import com.lavante.sim.customer.pageobjects.HomePage.LayoutPage;
...
import com.lavante.sim.customer.pageobjects.Tasks.CouponDeduction.CoupondeducQntoAnswer;
...
import com.lavante.sim.customer.pageobjects.Transactions.PromoAllowances.PromoAllowancePage;
...
import com.lavante.sim.customer.pageobjects.Transactions.NCH.NCHInvoice;
import com.lavante.sim.customer.pageobjects.Transactions.NCH.ViewNCHPage;
import com.lavante.sim.supplier.pageobjects.SupplierHomePage;
import com.lavante.sim.supplier.pageobjects.Agreements.CreateCostChangePage;
import com.lavante.sim.supplier.pageobjects.Agreements.ViewDetailsListCostChangePage;
import com.lavante.sim.supplier.pageobjects.Agreements.ListCostChangePage;
import com.lavante.sim.supplier.pageobjects.Items.CreateItemPage;
import com.lavante.sim.supplier.pageobjects.Items.SupplierItemSearch;
...
public class PageInitiator extends LavanteUtils {
	...
	public LayoutPage objLayoutPage = null;
	...
	public  CoupondeducQntoAnswer objCoupondeducQntoAnswer  = null;
	...
	public NCHInvoice objNCHInvoicePage = null;
	public ViewNCHPage objViewNCHPage = null;
	public PromoAllowancePage objPromoPage = null;
	...
	public SupplierItemSearch objItemSearch = null;
	public CreateItemPage objItemPage = null;
	public CreateCostChangePage objCostChangePage = null;
	public ListCostChangePage objListCostChangePage = null;
	public ViewDetailsListCostChangePage objListCostViewPage = null;
	...
	public void initiate() {
		...
		objLayoutPage = PageFactory.initElements(driver, LayoutPage.class);
		...
		objCoupondeducQntoAnswer = PageFactory.initElements(driver, CoupondeducQntoAnswer.class);
		...
		objNCHInvoicePage = PageFactory.initElements(driver, NCHInvoice.class);
		objViewNCHPage = PageFactory.initElements(driver, ViewNCHPage.class);
		objPromoPage = PageFactory.initElements(driver, PromoAllowancePage.class);
		...
		objItemSearch = PageFactory.initElements(driver, SupplierItemSearch.class);
		objItemPage = PageFactory.initElements(driver, CreateItemPage.class);
		objCostChangePage = PageFactory.initElements(driver, CreateCostChangePage.class);
		objListCostChangePage = PageFactory.initElements(driver, ListCostChangePage.class);
		objListCostViewPage = PageFactory.initElements(driver, ViewDetailsListCostChangePage.class);
