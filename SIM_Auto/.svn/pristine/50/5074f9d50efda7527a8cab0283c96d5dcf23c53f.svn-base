...
public class ClaimsAdvanceSearchTest extends PageInitiator{
	...
	public void AdvanceSearchBuildQuery(LinkedHashMap<String , String> dataMap ) throws Exception
	{
		...
		String data="";
		boolean act=enClaimsPage.myClaimsRadBtn1().isSelected();
		boolean act2=enClaimsPage.allClaimsRadBtn1().isSelected();
		softassert.assertEquals(act,myClaim,"My Claim Selection Not done");
		softassert.assertEquals(act2,AllClaim,"All Claim Selection Not done");
