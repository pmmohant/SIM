...
public class Myhomepage {
	...
	//
	@FindBy(xpath="//a[contains(@class,'user-info')]|//button[@id='dropdownMenuButton']")
	private WebElement angUserName;
	...
	@FindBy(css="li p a[href*='Download']")
	private WebElement ManageDwnloadsBtn;
	...
	@FindBy(xpath= "//*[@id='content']//*[contains(text(), 'Help/FAQ')]")
	private WebElement HelpFAQtext;
	public WebElement HelpFAQtext() {
		return HelpFAQtext;
	}
	
	//Agreements on Menu bar
	@FindBy(xpath= "//*[@id='main-navigation']//a[contains(text(),'Agreements')]")
	private WebElement Agreements;
	public WebElement Agreements() {
		return Agreements;
	}
	
	//List cost change under agreements
	@FindBy(xpath= "//*[@id='main-navigation']//a[contains(text(),'List Cost Changes')]")
	private WebElement listCostChange;
	public WebElement listCostChange() {
		return listCostChange;
	}
	...
	@FindBy(css="div[role*='dial'][class*='dial'] button[class*='prim']")
	...
	public void Downloadselect() {
		userNameSelect();
		lavanteUtils.click(ManageDwnloadsBtn);
	}
	...
	public void userNameSelect() {
		...
		lavanteUtils.click(angUserName);
	}
	...
	public void close() {
		...
		lavanteUtils.fluentwait(angUserName);
	}
