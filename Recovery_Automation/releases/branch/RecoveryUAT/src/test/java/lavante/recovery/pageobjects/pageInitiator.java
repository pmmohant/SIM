...
//import lavante.recovery.pageobjects.MainAssignPage.AuditStatisticsPage;
//import lavante.recovery.pageobjects.MainAssignPage.CreditsPage;
//import lavante.recovery.pageobjects.MainAssignPage.HoldsPage;
//import lavante.recovery.pageobjects.MainAssignPage.StatementsPage;
...
import lavante.recovery.pageobjects.Audit.AuditCustomerKPIPage;
...
public class pageInitiator extends LavanteUtils {
	...
	public AuditCustomerKPIPage auditCustomerKPIPage;       //added by Ramya
	public AssignmentsPage assignmentsPage;					//added by Ramya
	public ConfigurationPage configurationPage;             //added by Ramya
  ...
  public StatementsPage statementsPage;
	...
	/*	backGroundJobsPage = PageFactory.initElements(driver, BackGroundJobsPage.class);
		...
		*/
		backGroundJobsPage = PageFactory.initElements(driver, BackGroundJobsPage.class);
		faxJobPage = PageFactory.initElements(driver, FaxJobPage.class);   //added by Ramya
	    ...
	    auditCustomerKPIPage = PageFactory.initElements(driver,AuditCustomerKPIPage.class);     //added by Ramya
	    assignmentsPage = PageFactory.initElements(driver, AssignmentsPage.class);				//added by Ramya
	    configurationPage = PageFactory.initElements(driver,ConfigurationPage.class);           //added by Ramya
