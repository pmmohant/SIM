...
public class Dashboard_Claims extends pageInitiator {
	...
	public void AllClaimsChart() throws InterruptedException{
		...
		fluentwait(dashboardclaimsPage.allClaimsSelectChart());
	...
	public void ClaimsByTypeChart() throws InterruptedException{
		...
		fluentwait(dashboardclaimsPage.claimsByTypeSelectChart());
	...
	public void BatchedClaimsInvoicesTable() throws InterruptedException{
		...
		fluentwait(dashboardclaimsPage.batchedclaims());
		...
		fluentwait(claimsPage.startDate());
		...
		click(claimsPage.backButton());
		fluentwait(invoicePage.invoicesLink());
		click(dashboardclaimsPage.invoicesLink());
		fluentwait(dashboardclaimsPage.claimsByStatus()	);	expDate = dashboardclaimsPage.invoicesDates().get(0).getText();
