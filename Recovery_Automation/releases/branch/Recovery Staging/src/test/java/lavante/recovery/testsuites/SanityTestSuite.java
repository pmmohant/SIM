...
public class SanityTestSuite extends pageInitiator {
  ...
  public void preCondition(@Optional (Platform) String platform , @Optional (Browser) String browser,@Optional (Version) String version) throws IOException  {
 //public void preCondition() throws IOException {
  ...
  public void verifyauditInboundPage(){
	  ...
	  //Recognized faxes
	  auditInboundPage.verifyRecognizedFax();
	  ...
	  //Unrecognized faxes
	  auditInboundPage.verifyUnrecognizedFax();
	  auditInboundPage.verifyStatements();
